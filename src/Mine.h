#ifndef DMITRIJ_BAGAEV_MAIN_GAME_MINE_H
#define DMITRIJ_BAGAEV_MAIN_GAME_MINE_H
#include "./ProducingBuilding.h"
class Mine : ProducingBuilding {
 public:
    explicit Mine(int row, int col, int newId, const char* symbol, int health,
...
#endif  // DMITRIJ_BAGAEV_MAIN_GAME_MINE_H
